...
Build params `k_ext`, `prune_worst`, `non_zeros` (and `eps_ext=0.002`) were carried from the
small fronts; only `k_graph`, `max_dist`, `evpK` were swept on large.

| mode | k_graph | k_ext | prune | nz | max_dist | evpK | recall | AVX-512 (s) | AVX2 (s) | ratio |
|--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| mode4 | 26 | 32 | 9 | 608 | 500 | 50 | 0.7918 | 302.6 | 316.7 | 1.047 |
| **mode4** | **26** | **32** | **9** | **608** | **600** | **50** | **0.8021** | **312.9** | **328.3** | **1.049** |
| mode4 | 26 | 32 | 9 | 608 | 700 | 50 | 0.8107 | 323.0 | 339.7 | 1.052 |
| mode4 | 26 | 32 | 9 | 608 | 800 | 50 | 0.8178 | 332.1 | 350.1 | 1.054 |
| mode4 | 26 | 32 | 9 | 608 | 900 | 50 | 0.8237 | 340.3 | 359.7 | 1.057 |
| mode4 | 26 | 32 | 9 | 608 | 1000 | 50 | 0.8284 | 348.3 | 368.3 | 1.057 |
| mode4 | 26 | 32 | 9 | 608 | 1200 | 50 | 0.8351 | 360.9 | 382.6 | 1.060 |
| mode7 | 28 | 34 | 10 | 576 | 400 | 50 | 0.8067 | 400.8 | 392.3 | 0.979 |
| mode4 | 26 | 32 | 9 | 608 | 1400 | 50 | 0.8391 | 369.1 | 393.7 | 1.067 |
| mode4 | 32 | 24 | 11 | 512 | 900 | 50 | 0.8422 | 386.1 | 410.9 | 1.064 |
| mode7 | 32 | 24 | 11 | 512 | 400 | 50 | 0.8143 | 403.4 | 413.7 | 1.026 |
| mode4 | 32 | 24 | 11 | 512 | 800 | 100 | 0.8474 | 403.9 | 432.7 | 1.071 |
| mode7 | 32 | 24 | 11 | 512 | 500 | 50 | 0.8267 | 427.7 | 439.0 | 1.026 |
| mode7 | 32 | 24 | 11 | 512 | 600 | 50 | 0.8367 | 454.4 | 464.8 | 1.023 |
| mode7 | 28 | 34 | 10 | 576 | 800 | 75 | 0.8487 | 496.8 | 513.4 | 1.033 |
