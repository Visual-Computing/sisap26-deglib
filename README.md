...
| **deglib+evp Explore+asym (cpp)** | `M=32`, `MaxDist=200` | `evp+fp32` | 0.8 s | 4.6 s | 0.1 s | 2.5 s | 0 s | **8.0 s** | 0.8255 |
| **deglib+evp Explore+asym (cpp)** | `M=32`, `MaxDist=200` | `evp+fp16` | 0.8 s | 4.6 s | 0.1 s | 1.6 s | 0 s | **7.1 s** | 0.8255 |
